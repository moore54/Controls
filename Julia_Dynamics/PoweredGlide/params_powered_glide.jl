...
P[:pd0]    = -1000.0  # initial Down position (negative altitude)
...
P[:theta0] = 0.0*pi/180  # initial pitch angle
P[:psi0]   = 0.0  # initial yaw angle
P[:p0]     = 0.0  # initial body frame roll rate
