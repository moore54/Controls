...
for j = 1:N_CL
   ...
   PyPlot.savefig("./figures/free_analytical/$figname.pdf",transparent = true)
   ...
   figname = "flight_angle_power_analytical"
   PyPlot.figure(figname)
   ...
   # figname = "net_flight_angle_analytical"
   # PyPlot.figure(figname)
